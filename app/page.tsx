  ...
  return <main id="top" className="house-site">
    ...
    <section className="house-room bedroom-room" id="bedroom" aria-label="The American Bear bedroom">
      ...
      <div className="poster-wall">
        <figure className="wall-poster poster-one"><img src="/art/america-movie-collage-v1.png" alt="American movie collage" /></figure>
        <figure className="wall-poster poster-two"><img src="/art/america-sports-bear-supporter-v11.png" alt="American Bear sports collage" /></figure>
        <figure className="wall-poster poster-three"><img src="/art/america-crime-cinema-chuck-v1.png" alt="American crime cinema collage" /></figure>
      </div>
    </section>
