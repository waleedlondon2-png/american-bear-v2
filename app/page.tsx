  ...
  return <main id="top" className="house-site">
    ...
    <section className="house-room bedroom-room" id="bedroom" aria-label="The American Bear bedroom">
      ...
      <div className="poster-wall">
        ...
        <figure className="wall-poster bonus-poster"><img src="/art/america-movie-collage-v1.png" alt="Close-up movie scene from the American Bear wall of fame" /></figure>
        <figure className="wall-poster polaroid-poster poster-two"><img src="/art/america-sports-bear-supporter-v11.png" alt="American Bear sports collage" /></figure>
