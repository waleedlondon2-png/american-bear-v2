...
const biggestShowImages = [
  { src:"/art/america-movies-clean-v2.png", alt:"A panoramic American movie universe with action, science fiction, adventure, horror and western characters", label:"THE MOVIES" },
  { src:"/art/america-sports-clean-v2.png", alt:"American Bear among boxing, football, baseball, basketball, NASCAR, athletics and rodeo", label:"THE SPORTS" },
...
export default function Home() {
  return <main id="top">
    ...
    <section className="money-break" id="chapters" aria-label="This is America: money and mythology">
      ...
      <div className="money-cartoon"><img src="/art/america-money-neon-v2.png" alt="A sharply detailed American panorama of Hollywood, Mount Rushmore, stacks of dollar bills and a collection of firearms"/></div>
    </section>
